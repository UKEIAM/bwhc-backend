...
BWHC_APP_DIR="bwhc-rest-api-gateway-1.0-SNAPSHOT"  # Value 'bwhc-rest-api-gateway-1.0-SNAPSHOT' in this script template
...
if [ ! -f "$TARGET_DIR/$SERVICE_SCRIPT" ]; then

  echo "Copying $SERVICE_SCRIPT ..."
